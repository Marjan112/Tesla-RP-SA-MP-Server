...
CMD:animlist(playerid, params[])// 24/02/2014
{
    ...
    strcat(str, "/deal - /crack - /smokeanim - /groundsit - /chat - /chat2 - /dance - /fucku - /strip - /hide - /vomit - /eat - /chairsit - /reload\n");
    ...
    strcat(str, "/pee - /lean - /run - /poli - /surrender - /sit - /breathless - /seat - /rap - /cross - /ped - /jiggy - /gesture\n");
    strcat(str, "/sleep - /smoke - /urinate - /chora - /relax - /crabs - /stop - /wash - /mourn - /fuck - /tosteal\n");
    ...
    ShowPlayerDialog(playerid, DIALOG_SHOW_INFO, DIALOG_STYLE_MSGBOX, "{FFFFFF}Animations", str, "Ok", "Cancel");
    return 1;
}
...
CMD:surrender(playerid,params[])
    {
        ...
        else return SendClientMessage(playerid, COLOR_GRAD2, "[ERROR]: No puedes usar este comando ahora.");
    }
...
CMD:sit(playerid,params[])
    {
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /sit [1-5]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /sit [1-5]");
        }
        return 1;
    }
...
CMD:sleep(playerid,params[])
    {
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /sleep [1-2]");
        switch(anim){
...
CMD:cheer(playerid,params[])
    {
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /cheer [1-8]");
        switch(anim){
 ...
 CMD:urinate(playerid,params[]){
        ...
        if(GetPVarInt(playerid, "Injured") == 1) return SendClientMessage(playerid, COLOR_GRAD2, "[ERROR]: No puedes usar este comando ahora.");
...
CMD:dj(playerid,params[]){
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /dj [1-4]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /dj [1-4]");
        }
        return 1;
    }
...
CMD:breathless(playerid,params[]){
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /breathless [1-2]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /breathless [1-2]");
        }
        return 1;
    }
...
CMD:poli(playerid,params[]){
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /poli [1-2]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /poli [1-2]");
        }
        return 1;
    }
...
CMD:seat(playerid,params[]){
        ...
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /seat [1-7]");
        if(anim < 1 || anim > 7) return SendClientMessage(playerid,COLOR_WHITE,"USE: /seat [1-7]");
        switch(anim){
...
CMD:dance(playerid,params[]){
        new dancestyle;
        if(sscanf(params, "d", dancestyle)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /dance [1-3]");
        switch(dancestyle){
...
CMD:cross(playerid,params[]){
        new anim;
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /cross [1-5]");
        ...
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /cross [1-5]");
        }
        return 1;
    }
...
CMD:jiggy(playerid,params[])
    {
        new anim;
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /jiggy [1-10]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /jiggy [1-10]");
        }
        return 1;
    }
...
CMD:ped(playerid,params[]){
        new anim;
        if(sscanf(params, "d", anim)) return SendClientMessage(playerid,COLOR_WHITE,"USE: /ped [1-26]");
        switch(anim){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /ped [1-26]");
        }
        return 1;
    }
...
CMD:rap(playerid,params[]){
        new rapstyle;
        if(sscanf(params, "d", rapstyle)) return SendClientMessage(playerid, COLOR_WHITE, "USE: /rap [1-3]");
        switch(rapstyle){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /rap [1-3]");
        }
        return 1;
    }
...
CMD:gesture(playerid,params[]){
        new gesture;
        if(sscanf(params, "d", gesture)) return SendClientMessage(playerid, COLOR_WHITE, "USE: /gesture [1-15]");
        switch(gesture){
            ...
            default: return SendClientMessage(playerid,COLOR_WHITE,"USE: /gesture [1-15]");
        }
        return 1;
    }
...
CMD:smoke(playerid,params[]){
        ...
        if(sscanf(params, "d", gesture)) return SendClientMessage(playerid, COLOR_WHITE, "USE: /smoke [1-2]");
        switch(gesture){
            ...
            default: return SendClientMessage(playerid, COLOR_WHITE, "USE: /smoke [1-2]");
        }
        return 1;
    }
...
{
    new num;
    if(sscanf(params, "i", num)) return SendClientMessage(playerid, COLOR_GRAD1, " USAGE: /chat [1-2]");
    if(num > 2 || num < 1) { SendClientMessage(playerid, COLOR_GRAD1, " USAGE: /chat [1-2]"); }
...
{
    new number;
    if(sscanf(params, "i", number)) return SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /sup [1-3]");
    if(number < 1 || number > 3) { SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /sup [1-3]"); }
...
{
    new nbr;
    if(sscanf(params, "i", nbr)) return SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /knife [1-4]");
    if(nbr < 1 || nbr > 4) return SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /knife [1-4]"); 
    switch(nbr)
    { 
...
{
    new ddr;
    if (sscanf(params, "i", ddr)) return SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /basket [1-6]");
    if(ddr < 1 || ddr > 6) return SendClientMessage(playerid,0xEFEFF7AA,"USAGE: /basket [1-6]"); 
    switch(ddr)
    {
...
CMD:lranim(playerid, params[])
{
    if(IsInLowRider(playerid))
    {
        ...
        if(sscanf(params, "i", choice))
        {
            ...
            SendClientMessage(playerid, COLOR_GRAD2, "Available options: 0-36");
            return 1;
        }
        if(GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
        {
            SendClientMessage(playerid, COLOR_GRAD2, "  You cannot be the driver of the vehicle!");
            return 1;
        }
        switch(choice)
        {
    ...
    {
        SendClientMessage(playerid, COLOR_GRAD2, "  You must be in a compatible lowrider to use this command!");
    }
    return 1;
}